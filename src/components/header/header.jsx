...
class Header extends Component {
        ...
        <div className={ classes.headerV2 }>
          <div className={ classes.icon }>
            <img
              ...
              onClick={ () => { this.nav('') } }
            />
            <Typography variant={ 'h3'} className={ classes.name } onClick={ () => { this.nav('') } }>ycredit.finance</Typography>
          </div>
          <div className={ classes.links }>
            { this.renderLink('collateral') }
  ...
  renderLink = (screen) => {
    ...
    return (
      <div className={ (window.location.pathname==='/'+screen || (screen === 'collateral' && window.location.pathname==='/'))?classes.linkActive:classes.link } onClick={ () => { this.nav(screen) } }>
